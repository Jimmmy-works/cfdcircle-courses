...
export default function Header() {
  const { profileInfo, handleLogOut, openAuthenModal, isAuthenModalOpen } =
    useAuthen();
  const token = localStorage.getItem(LOCAL_STORAGE.token);
  const { dropDown, setDropDown, toggleNav, handleNavbar } = useAuthen();
    ...
    <header className="header --bgwhite">
      <div className="container-fluid">
        <div
          ...
          className={`header__humburger ${toggleNav ? "--close" : ""}`}
        >
        ...
        <div onClick={() => setDropDown(!dropDown)} className="header__logged">
          <div className="userlogged">
            ...
            >
              {token ? (
                ...
                <UserOutlined style={{ fontSize: 30, paddingRight: 5 }} />
              )}
